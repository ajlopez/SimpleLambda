...
exports['Create apply'] = function (test) {
    const a = sl.createApply(sl.createVariable('x'), sl.createVariable('y'));
...
exports['Create apply with left apply'] = function (test) {
    const a = sl.createApply(sl.createApply(sl.createVariable('x'), sl.createVariable('y')), sl.createVariable('z'));
...
exports['Create apply with right apply'] = function (test) {
    const a = sl.createApply(sl.createVariable('x'), sl.createApply(sl.createVariable('y'), sl.createVariable('z')));
...
exports['Substitute left variable'] = function (test) {
    ...
    const result = a.substitute('x', sl.createVariable('z'));
...
exports['Substitute right variable'] = function (test) {
    ...
    const result = a.substitute('y', sl.createVariable('z'));
...
exports["Don't substitute not found variable"] = function (test) {
    ...
    const result = a.substitute('w', sl.createVariable('z'));
